...
# Config
model_path = "save/checkpoints/OpenSora-STDiT-v3-INT8-Naive/model.safetensors"
resolution = "720p"
aspect_ratio = "9:16"
num_frames = "4s"
seed = 42
...
logger.info("Model: ({}, {}) \n{}".format(model.dtype, model.device, model))
for name, param in model.named_parameters():
    logger.info(f"Layer: {name}, Data Type: {param.dtype}")
logger.success("Load successfully!")
