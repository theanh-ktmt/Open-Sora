...
class RotaryEmbedding(Module):
    ...
    def forward(self, t, seq_dim=None, offset=0, freq_seq_len=None):
    ...
    def rotate_queries_and_keys(self, q, k, seq_dim=None):
        ...
        freqs = self.forward_(seq, seq_len=seq_len)
    ...
    def get_axial_freqs(self, *dims):
        ...
        for ind, dim in enumerate(dims):
            ...
            freqs = self.forward_(pos, seq_len=dim)
    ...
    # rename from forward
    @autocast(enabled=False)
    def forward_(self, t: Tensor, seq_len=None, offset=0):
        should_cache = (
